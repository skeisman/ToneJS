...
module ng {
    ...
    interface IAngularStatic {
        ...
        module(/** name of your module you want to create */
               ...
               requires?:string[], configFunction?:Function): IModule;
        noop(...args:any[]): void;
    ...
    interface IModule {
        ...
        factory(name:string, serviceFactoryFunction:any): IModule;
        factory(name:string, inlineAnnotadedFunction:any[]): IModule;
        filter(name:string, filterFactoryFunction:any): IModule;
        filter(name:string, inlineAnnotadedFunction:any[]): IModule;
        provider(name:string, serviceProviderConstructor:any): IModule;
        provider(name:string, inlineAnnotadedConstructor:any[]): IModule;
        run(initializationFunction:any): IModule;
